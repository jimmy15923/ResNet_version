...
def normalize_layer(tensor, name, norm_use='bn'):
    ...
    if norm_use == "gn":
        ...
        x = SwitchNorm(name=name+"sn")(tensor)
    return x
...
if __name__ == '__main__':
    ...
    """
    pretrain_modules = ResNet50V2(include_top=False, input_shape=(128,128,3), norm_use="gn", weights='imagenet')
    ...
    arr_x = np.random.random((100, 224, 224, 3))
